  ...
  Future<void> _promptExactAlarmPermission(BuildContext context) async {
    await showDialog(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: Text(
          'لكي يعمل تنبيه حديث اليوم في موعده الدقيق تماماً حتى أثناء قفل الشاشة أو سكون الهاتف، يلزم تفعيل إذن «التنبيهات والمواعيد» (Alarms & Reminders) للتطبيق في نظام أندرويد.\n\nاضغط «تفعيل الإذن الآن» لفتح صفحة الإعدادات وتفعيل الخيار.',
